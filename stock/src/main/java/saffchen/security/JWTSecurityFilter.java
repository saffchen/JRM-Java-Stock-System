...
public class JWTSecurityFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JWTSecurityFilter(JwtUtil jwtUtil, PersonEntityDetailsService personEntityDetailsService) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authHeader != null && !authHeader.isBlank() && authHeader.startsWith(prefix)){
            ...
            if (onlyToken.isBlank()){
                ...
                try {
                    String username = jwtUtil.validateTockenAndGetClaim(onlyToken);
